...
using Groupyfy.Security.IS.Models.Account;
using IdentityModel;
...
namespace Groupyfy.Security.IS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(string returnUrl)
        {
            ...
            if(vm.CandidateLogin)
            {
                return RedirectToActionPermanent("CandidateLogin", new { returnUrl = returnUrl });
            }
        ...
        [Authorize]
        [HttpPost]
        public async Task<IActionResult> PickRole(PickRoleInputModel model)
        {
            var user = await _userManager.FindByIdAsync(User.Claims.FirstOrDefault(x => x.Type.ToLower() == "sub").Value);

            await HttpContext.SignOutAsync(IdentityConstants.ApplicationScheme);
            await HttpContext.SignInAsync(IdentityConstants.ApplicationScheme, await StoreRememberClient(user, model.Role, model.CorporateId));
        ...
        private async Task<LoginViewModel> BuildLoginViewModelAsync(string returnUrl)
        {
            ...
            if (context?.IdP != null)
            {
                ...
                {
                    CandidateLogin = context.Parameters["offerid"] != null,
