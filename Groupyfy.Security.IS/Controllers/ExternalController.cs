...
namespace Groupyfy.Security.IS.Controllers
{
    ...
    {
        private readonly UserManager<GroupyfyUser> _userManager;
        ...
        public ExternalController(
            UserManager<GroupyfyUser> userManager,
        ...
        private async Task<(GroupyfyUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
